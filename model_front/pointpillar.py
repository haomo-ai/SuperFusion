...
class PointPillar(nn.Module):
    ...
    def forward(self, points, points_mask,
        ...
        voxel_feature = torch.cat(
            [voxel_feature1, voxel_feature2, voxel_feature3], dim=1)
...
class PointPillarEncoder(nn.Module):
    def __init__(self, C, xbound, ybound, zbound, ppdim=15):
    ...
    def forward(self, points, points_mask):
        ...
        voxel_feature = torch.cat(
            [voxel_feature1, voxel_feature2, voxel_feature3], dim=1)
        return self.conv_out(voxel_feature).transpose(3, 2), neck_feature
